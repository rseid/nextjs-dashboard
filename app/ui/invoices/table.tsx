                ...
                <div className="flex items-center justify-between border-b pb-4 dark:border-gray-700">
                  <div>
                    <div className="mb-2 flex items-center">
                      ...
                      />
                      <p className="dark:text-gray-100">{invoice.name}</p>
                    </div>
          ...
          <table className="hidden min-w-full text-gray-900 md:table dark:text-gray-100">
            ...
            <tbody className="bg-white dark:bg-gray-800">
              {invoices?.map((invoice) => (
                <tr
                  key={invoice.id}
                  className="w-full border-b py-3 text-sm last-of-type:border-none dark:border-gray-700 [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg"
                >
