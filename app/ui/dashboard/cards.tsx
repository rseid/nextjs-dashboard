...
export default async function CardWrapper() {
  // Disabled - no database connected
  // const {
  //   numberOfInvoices,
  //   numberOfCustomers,
  //   totalPaidInvoices,
  ...
  const totalPaidInvoices = '$0.00';
  const totalPendingInvoices = '$0.00';
    ...
    <div className="rounded-xl bg-gray-50 p-2 shadow-sm dark:bg-gray-800">
      ...
      <p
        className={`${lusitana.className}
          truncate rounded-xl bg-white px-4 py-8 text-center text-2xl dark:bg-gray-900 dark:text-gray-100`}
      >
        {value}
      </p>
    </div>
